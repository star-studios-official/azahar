...
FRD_A::FRD_A(std::shared_ptr<Module> frd) : Module::Interface(std::move(frd), "frd:a", 8) {
    static const FunctionInfo functions[] = {
        ...
        {0x0401, &FRD_A::CreateLocalAccount, "CreateLocalAccount"},
        {0x0402, nullptr, "DeleteLocalAccount"},
        {0x0403, &FRD_A::LoadLocalAccount, "LoadLocalAccount"},
        {0x0404, &FRD_A::UnloadLocalAccount, "UnloadLocalAccount"},
