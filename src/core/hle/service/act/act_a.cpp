...
ACT_A::ACT_A(std::shared_ptr<Module> act) : Module::Interface(std::move(act), "act:a") {
    const FunctionInfo functions[] = {
        ...
        // act:a
        {0x0402, &ACT_A::CreateConsoleAccount, "CreateConsoleAccount"},
        {0x0403, &ACT_A::CommitConsoleAccount, "CommitConsoleAccount"},
        {0x0404, &ACT_A::UnbindServerAccount, "UnbindServerAccount"},
        {0x0405, nullptr, "DeleteConsoleAccount"},
        {0x0407, &ACT_A::UnloadConsoleAccount, "UnloadConsoleAccount"},
        {0x0408, nullptr, "EnableAccountPasswordCache"},
        {0x0409, &ACT_A::SetDefaultAccount, "SetDefaultAccount"},
