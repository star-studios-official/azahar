...
Look for a detail screen where the primary content is full height and the
secondary action or metadata panel is below it. Apply this pattern to that pair
of views without copying app-specific paths or naming from another project.
