...
- Check `Planning Swift module` time. If it is significant in incremental builds, escalate to `xcode-project-auditor` to investigate unexpected input invalidation or misconfigured scripts.
...
Hand findings to `xcode-project-auditor` when:
