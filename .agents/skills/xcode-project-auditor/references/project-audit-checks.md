...
Audit project-level and target-level settings against the [build settings best practices](../../../shared/build-optimization/references/build-settings-best-practices.md). Present results as a checklist with `[x]`/`[ ]` indicators.
